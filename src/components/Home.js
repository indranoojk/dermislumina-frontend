  ...
  return (
    <>
        ...
        <div className="fixed top-[100px] lg:top-[115px] right-8 lg:right-5 z-10">
            <Link to='/skincare'>
                <button className="animate-pulse hover:animate-none bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg">Take Assessment</button>
            </Link>
        </div>

        <div className="grid grid-cols-1 lg:grid lg:grid-cols-2">
            {/* row 1 */}
            <div className="lg:pl-5 row-start-2 lg:row-span-1 text-center transition animate-slide-right">
            ...
            {/* row 3 */}
            <div className="lg:pl-5 row-start-6 lg:row-start-3 text-center animate-slide-right">
        ...
        <div className="p-20 lg:p-0 lg:m-20">
            ...
            <div className="lg:grid lg:grid-cols-5 lg:grid-rows-2">
                {/* Grid 1 */}
                <div className="col-start-1 hover:transition hover:-translate-y-1 hover:ease-in-out hover:contrast-125">
                    <img className='w-[250px] h-[250px] hover:rounded-xl hover:drop-shadow-2xl' src="https://images.pexels.com/photos/6476081/pexels-photo-6476081.jpeg?auto=compress&cs=tinysrgb&w=1280" alt="" />
                </div>
                ...
                {/* Grid 2 */}
                <div className="row-start-2 col-start-2 hover:transition hover:-translate-y-1 hover:ease-in-out hover:contrast-125">
                    <img className='w-[250px] h-[250px] hover:rounded-xl hover:drop-shadow-2xl' src={dryskin} alt="" />
                </div>
                ...
                {/* Grid 3 */}
                <div className="col-start-3 hover:transition hover:-translate-y-1 hover:ease-in-out hover:contrast-125">
                    <img className='w-[250px] h-[250px] hover:rounded-xl hover:drop-shadow-2xl' src={wrinkles} alt="" />
                </div>
                ...
                {/* Grid 4 */}
                <div className="row-start-2 col-start-4 hover:transition hover:-translate-y-1 hover:ease-in-out hover:contrast-125">
                    <img className='w-[250px] h-[250px] hover:rounded-xl hover:drop-shadow-2xl' src={darkSpot} alt="" />
                </div>
                ...
                {/* Grid 5 */}
                <div className="col-start-5 hover:transition hover:-translate-y-1 hover:ease-in-out hover:contrast-125">
                    <img className='w-[250px] h-[250px] hover:rounded-xl hover:drop-shadow-2xl' src={redness} alt="" />
                </div>
